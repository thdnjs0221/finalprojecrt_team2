...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/kjh/CompanyAdvrt.js" />
...
<div class="imgAdvrtWrap">
	<div id="content" class="companyAdvrt-main-content__inner">
	    <section>
	        <div class="page-top-head">
	            <h2 class="page-top-head__title">기업의 채용 글을 '메인페이지'에서 가장 눈에 띄게, </h2>
	            <p class="page-top-head__desc">다수 구직자에게 효과적으로 공고를 홍보하는 상품!</p>
	        </div>
	        <div class="prod-content">
	            <div class="prod-preview">
	                <div role="tablist" class="tab__list prod-preview__tab"><button type="button" role="tab" class="tab__btn" aria-selected="true" disabled>기업 광고</button></div>
	                <div class="prod-preview__container prod-preview__container--medium"><img class="_transition" src="<%=request.getContextPath() %>/resources/upload/ImgAdForm/cmpAdvrt_Image.png" alt="" style="transform: translateY(0px);"></div>
	            </div>
	            <div class="prod-list" id="CompanyAdvrtBody">
...
<!--결제 확인 Modal 시작 -->
<div id="CmpAdvrtPayModal" class="modal fade">
		...
		<div class="modal-content">
			...
			<div class="PeriodTicketPayment-footer">
				<div class="modal-footer">
					...
					<a href="#" id="memBuyBtn" class="btn btn-danger btn-icon-split" onclick="CmpAvrtPayModal_onclick()" data-bs-toggle="modal" data-bs-target="#CmpAdvrtPayModal_process"> 
...
<!--결제 상세 Modal 시작 -->
<div id="CmpAdvrtPayModal_process" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="payPocess">
