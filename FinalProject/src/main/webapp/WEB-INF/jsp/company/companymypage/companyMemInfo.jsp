        ...
        <div id="content" class="basic">
            <div id="sri_gnb_wrap">
                <ul class="gnb">
                    ...
                    <li class="only"><a href="<%=request.getContextPath()%>/companyMyPromotionView" onmousedown="pushDataLayer('ga_lead', 'pc_my_gnb', 'alarm', '')">
                            <svg>
...
<!--                     <li class="select"><button type="button" class="inTab" onclick="location.href='/zf_user/company-join/edit?tabType=basic_info'; return false;"> -->
<!--                             <span>기본정보</span> -->
<!--                         </button></li> -->
<!--                     <li> -->
<!--                         <button type="button" class="inTab" onclick="location.href='/zf_user/company-join/edit?tabType=main_company'; return false;"> -->
<!--                             <span>대표 기업정보</span> -->
<!--                         </button> -->
<!--                     </li> -->
...
<!--                 </ul> -->
                ...
                <div class="companyinfo_modify_wrap">
                    ...
                    <div class="tblWrap tblRow tblBorder">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><span class="required"><b>*</b> 이름</span>
                                    </th>
                                    <td colspan="2" class="txtLeft">
                                        ${member.company.companyDnm }</td>
                                </tr>
                                <tr>
                                    <th scope="row"><span class="required"><b>*</b> 연락처</span>
                                    </th>
                                    <td class="txtLeft">${member.memTel }</td>
                                </tr>
                                <tr>
                                    <th scope="row"><span class="required"><b>*</b> 이메일</span>
                                    </th>
                                    <td class="txtLeft" colspan="2">${member.memMail }</td>
                                </tr>
                                <tr>
                                    <td colspan="2"><button type="button" id="btnEdit" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary">수정</button> <input type="hidden" name="_method" value="put">
                                        <button data-bs-toggle="modal" id="btnExit" data-bs-target="#exampleModal" class="btn btn-danger">탈퇴</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="companyinfo_modify"></div>

                    <form id="frmExit" action="/FinalProject/companyMemInfo/exitPost" hidden method="post">
                    ...
                    <script>
                        (function($) {
                            ...
                            var processFlag = '';
                            $(
                                    "input[name='agency_file_nm_certification'], input[name='file_nm_certification'], input[name='agency_file_nm']")
                                .bind(
                                    "change",
                                    function() {
                            ...
                            $('#btnMaskingEmailCompare').on('click',
                                function() {
                                    maskingEmailCompare();
                                });
                            ...
                            function maskingMode(type) {
                                if (type === 'masking') {
                                    ...
                                    $('#maskingCompareForm').css("display",
                                        "none");
                                    $('#sendEmailForm').css("display", "none");
                                    $('#sendEmailCodeForm').css("display",
                                        "none");
                                    ...
                                    if ($('#maskingEmailForm').text().trim().length < 1 ||
                                        $('#maskingEmailForm').text()
                                        .trim() === '-') {
                                        $('#fit_masking_fl').val('y');
                                        $('#maskingCompareForm').css("display",
                                            "none");
                                        $('#sendEmailForm').css("display",
                                            "block");
                                        $('#btnEditEmail').hide();
                            ...
                            function checkDuplicateEmail(email) {
                                ...
                                $
                                    .ajax(
                                        '/zf_user/company-join/check-duplicate-email', {
                                            type: 'POST',
                                            data: {
                                                email: email
                                            },
                                        ...
                                        '/zf_user/persons/send-code', {
                                            ...
                                            success: function(json) {
                                                ...
                                                if (json.code === "certification_notice") {
                                                    return alert("일시적인 오류로 인하여 " +
                                                        json.message +
                                                        " 이용이 불가능합니다. 잠시 후 다시 이용해주세요.");
                                                }
                                                startSmsConfirm();
                                                alert("인증번호가 발송되었습니다.");
                                                sendCodeMode('send');
                            ...
                            function startSmsConfirm() {
                                ...
                                function setTimeText(minute, second) {
                                    var second_text = (second / 10) < 1 ? "0" +
                                        second : second;
                                    $('#remain_time_mail').html(
                                        minute + ':' + second_text);
                                }
            ...
            <script type="text/javascript">
                (function($) {
                    ...
                    $(
                            "input[name='file_nm_certification'], input[name='agency_file_nm']")
                        .bind(
                            "change",
                            function() {
                                ...
                                if (file &&
                                    ...
                                    if (file)
                                        alert("파일이 첨부되지 않았습니다. 파일 확장자/용량을 확인해주세요.");
                                    $(this).val("");
                                    return false;
                                }
                            });
                    ...
                    // 기업정보 뷰 팝업
                    $('.company_info_view_btn').on(
                        'click',
                        function() {
                            window.open('/zf_user/company-info/view?csn=' +
                                $(this).data('csn'), '');
                            return false;
                        });

                    // Sample 기업정보 뷰 팝업
                    $('.sample_company_info_view_btn')
                        .on(
                            'click',
                            function() {
                                window
                                    .open(
                                        '/zf_user/company-info/view?csn=3810072663',
                                        '');
                                return false;
                            });
                    ...
                    $('.nice_request_btn')
                        .on(
                            ...
                            function() {
                                window
                                    .open(
                                        'https://minwon.dataline.co.kr/p06/A0601M001.nice?offer_id=206',
                                        "nice_popup",
                    ...
                    // 이크레더블 평가 보고서
                    $('.evaluation_report_url_btn')
                        .on(
                            'click',
                            function() {
                                window
                                    .open($(this).data('url'), '',
                                        'width=1000,height=958,scrollbars=yes,status=no');
                                return false;
                            });

                    // 이크레더블 수정 요청 팝업
                    $('.ecredible_request_btn')
                        .on(
                            'click',
                            function() {
                                window
                                    .open(
                                        'http://www.ecredible.co.kr/echome/customer/contact.jsp',
                                        "ecredible_popup",
                                        "width=1100,height=800,scrollbars=yes");
                                return false;
                            });
                    ...
                    $('#content')
                        .on(
                            ...
                            function() {
                                ...
                                $clonedRow.find('input, select')
                                    .val('');
                                $clonedRow.find('.in_tablebot_txt')
                                    .text('');
                    ...
                    // 지점 로고 삭제
                    $('#branch_logo_delete_btn')
                        .on(
                            'click',
                            function() {
                                var mcom_idx = $(this).data('mcom_idx');
                                if (confirm('삭제하시겠습니까?')) {
                                    location.href = '/zf_user/company-photo/delete-logo/mcom_idx/' +
                                        mcom_idx;
                                }
                            });
                    ...
                    $('#preview_btn')
                        .on(
                            ...
                            function() {
                                ...
                                var $form = $('#frm'),
                                    previousFormAction = $form
                                    .attr('action'),
                                    targetWin = 'preview';

                                $form
                                    .attr('action',
                                        '/zf_user/company-info/preview');

                                var previewWindow = window.open(
                                    'about:blank', targetWin);
                    ...
                    $('#main_company_data_edit_btn')
                        .on(
                            ...
                            function() {
                                ...
                                var $emptyInput = $('#workenvForm')
                                    .find(
                                        'input[id^=image_attachment_photo_]:not(:disabled)')
                                    .filter(
                                        function() {
                                            return this.value
                                                .trim() === "";
                    ...
                    // 요청 하기
                    $('#request_company_data_btn')
                        .on(
                            'click',
                            function() {
                                var $frm = jQuery('#request_frm');

                                if (!$frm.find('#private_agree').is(
                                        ":checked")) {
                                    alert('개인정보 수집 동의 버튼을 체크해주세요.');
                                    return false;
                                }

                                if ($frm.find('input[name=email_id]')
                                    .val() == '') {
                                    alert('요청자 이메일은 필수 항목입니다.');
                                    return false;
                                }

                                if ($frm.find('#order_select').val() == '0' &&
                                    $frm.find(
                                        'input[name=email_dm]')
                                    .val() == '') {
                                    alert('요청자 이메일은 필수 항목입니다.');
                    ...
                    //기업명 신청
                    $('#request_modify_company_nm_frm_btn')
                        .on(
                            'click',
                            function() {
                                ...
                                if ($frm.find('#modify_company_nm')
                                    .val() == '') {
                                    alert('기업명(변경)을 확인하세요.');
                                    return false;
                                }

                                if ($frm.find('#file_nm_certification')
                                    .val() == "") {
                                    alert('증빙자료 이미지를 첨부해주세요.');
                                    return false;
                                }
